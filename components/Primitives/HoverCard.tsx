...
export const HoverCard: React.FC<HoverCardProps> = ({
  children, content, openDelay = 0, closeDelay = 100, sideOffset = 4, side = 'top', contentStyle={
    ...
    <HoverCardPrimitive.Root openDelay={openDelay} closeDelay={closeDelay} {...rest}>
      ...
      <HoverCardPrimitive.Portal>
        ...
        >
          ...
          <div className={cn("flex text-xs leading-none text-primary break-words overflow-auto w-auto", className)} style={contentStyle}>{tooltipContent}</div>
        </HoverCardPrimitive.Content>
      </HoverCardPrimitive.Portal>
