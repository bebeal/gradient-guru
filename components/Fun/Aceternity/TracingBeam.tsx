...
export const TracingBeam = ({
  ...
  return (
    <div ref={containerRef} className="relative flex w-full h-auto overflow-auto max-h-[400px]">
    <motion.div
    ...
    >
      ...
      <div className="flex h-auto w-auto overflow-hidden" ref={contentRef}>{children}</div>
    </motion.div>
    </div>
  );
};
