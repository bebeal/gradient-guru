    ...
    <PinContainer
      ...
      >
        <div className="flex basis-full flex-col p-4 tracking-tight text-slate-100/50 sm:basis-1/2 w-[20rem] h-full">
          ...
          {content ? <div className="flex w-auto h-full rounded-lg justify-center items-center mt-4">{content}</div> : <div className="flex flex-1 w-full rounded-lg mt-4 bg-gradient-to-br from-violet-500 via-purple-500 to-blue-500" />}
        </div>
    </PinContainer>
  )
};
