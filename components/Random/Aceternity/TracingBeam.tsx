...
export const TracingBeam = ({ children, className }: { children: ReactNode; className?: string }) => {
  ...
  return (
    <div ref={containerRef} className="relative flex w-full h-auto overflow-auto max-h-[600px]">
      <motion.div className={cn('relative w-full max-w-4xl mx-auto h-auto', className)}>
        <div className="absolute -left-20 top-3">
          <motion.div
            ...
            animate={{
              boxShadow: scrollYProgress.get() > 0 ? 'rgba(0, 0, 0, 0) 0 0 0' : 'rgba(0, 0, 0, 0.24) 0px 3px 8px',
            }}
          ...
          >
            <motion.div
              ...
              animate={{
                ...
                borderColor: scrollYProgress.get() > 0 ? '#FFFFFF' : '#10b981',
              }}
        ...
        <div className="flex h-auto w-auto overflow-hidden" ref={contentRef}>
          {children}
        </div>
      </motion.div>
    </div>
