...
export const FlowFormItem = forwardRef<any, any>((props, ref) => {
  ...
  if (item === 'node-schema') {
    return (
      <div className={"w-full h-full grid grid-cols-1 col-span-2 gap-1 overflow-auto rounded items-center"}><FormFields form={form} schema={schema} readOnly={readOnly} ItemRenderer={FlowFormItem} /></div>
    );
