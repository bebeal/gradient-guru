...
import { TLUiToolItem } from '@tldraw/tldraw/src/lib/ui/hooks/useTools'
...
import { MobileStylePanel } from '@tldraw/tldraw/src/lib/ui/components/MobileStylePanel'
...
import { ToggleToolLockedButton } from '@tldraw/tldraw/src/lib/ui/components/Toolbar/ToggleToolLockedButton';
import { cn, kbdStr } from '@tldraw/tldraw/src/lib/ui/components/primitives/shared';

export interface FlowToolbarProps {
  extras?: boolean;
}
export const FlowToolbar = memo((props: FlowToolbarProps) => {
  const {
    extras=true,
  } = props
			...
			<div className="tlui-toolbar__inner">
              ...
              <div className="tlui-toolbar__extras__controls tlui-buttons__horizontal">
                ...
                <ActionsMenu />
					...
					<div
						className={cn('tlui-toolbar__tools', {
