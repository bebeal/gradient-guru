...
export const CodeLanguagesIconSet = Object.entries(CodeLanguages).reduce<Record<CodeLanguage, CodeLanguageProperties>>((acc, [codeLanguage, codeLanguageProperties]) => {
