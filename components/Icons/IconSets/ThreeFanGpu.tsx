...
export const GpuPartVariantSets: Record<GpuVariantSet, Record<GpuParts, VariantSet>> = {
  ...
  "realistic": {
    "base": { color: "#2C3E50", className: cn("fill-[url(#baseGradient)] stroke-[url(#baseGradient)] [box-shadow:0_4px_6px_rgba(0, 0, 0, 0.1)]") },                         // dark grey blue gradient
    "fan-1": { color: "#BDC3C7", className: cn("fill-[url(#fanGradient)] stroke-[url(#fanGradient)] [box-shadow:inset_-2px_-2px_4px_#8a949e,inset_2px_2px_4px_#d5dce3]") }, // silver gradient
    "fan-2": { color: "#BDC3C7", className: cn("fill-[url(#fanGradient)] stroke-[url(#fanGradient)] [box-shadow:inset_-2px_-2px_4px_#8a949e,inset_2px_2px_4px_#d5dce3]") }, // silver gradient
    "fan-3": { color: "#BDC3C7", className: cn("fill-[url(#fanGradient)] stroke-[url(#fanGradient)] [box-shadow:inset_-2px_-2px_4px_#8a949e,inset_2px_2px_4px_#d5dce3]") }, // silver gradient
    "PCIE": { color: "#F39C12", className: cn("fill-[url(#pcieGradient)] stroke-[url(#pcieGradient)] [box-shadow:0_4px_6px_rgba(0, 0, 0, 0.1)] ") },                        // gold gradient
    "inner-circle": { },
    "gpu": { className: cn("w-auto h-auto") },
  }
};
...
export const ThreeFanGpu = forwardRef((props: ThreeFanGpuProps, ref?: any) => {
  ...
  const getPartProperties = useCallback((part: GpuParts, partVariant: GpuVariantSet = variant) => {
  ...
  const BaseGpuIcon = useCallback((props: BaseGpuIconProps) => {
    const {
      gpuVariant = variant,
      className='',
      ...rest
      ...
      <svg id="gpu" viewBox="0 0 85 35.86" ref={internalRef} {...gpuStyles} className={gpuClassName} {...rest}>
        <SvgRealisticGradients />
          ...
          <g id="fan-2" {...getPartProperties("fan-2", gpuVariant)}>
            {/* Center fan */}
            <path id="inner-circle" {...getPartProperties("inner-circle", gpuVariant)} d="m43.43 20.55c0.01 0 0.02-0.01 0.03-0.01 1.83-0.43 3.2-2.08 3.2-4.05 0-0.07 0-0.14-0.01-0.22v-0.02c-0.11-2.01-1.66-3.65-3.63-3.9h-0.02c-0.16-0.02-0.33-0.03-0.5-0.03-1.87 0-3.45 1.24-3.98 2.94 0 0.01 0 0.02-0.01 0.02-0.11 0.38-0.18 0.78-0.18 1.2 0 0.58 0.12 1.13 0.33 1.63v0.01c0.64 1.48 2.11 2.52 3.82 2.52 0.34 0.01 0.65-0.03 0.95-0.09z"/>
          ...
          <g id="fan-3" {...getPartProperties("fan-3", gpuVariant)}>
            {/* Right side fan */}
            <path id="inner-circle" {...getPartProperties("inner-circle", gpuVariant)} d="m71.07 20.55c0.01 0 0.02-0.01 0.03-0.01 1.83-0.43 3.2-2.08 3.2-4.05 0-0.07 0-0.14-0.01-0.22v-0.02c-0.11-2.01-1.66-3.65-3.63-3.9h-0.02c-0.16-0.02-0.33-0.03-0.5-0.03-1.87 0-3.45 1.24-3.98 2.94 0 0.01 0 0.02-0.01 0.02-0.11 0.38-0.18 0.78-0.18 1.2 0 0.58 0.12 1.13 0.33 1.63v0.01c0.64 1.48 2.11 2.52 3.82 2.52 0.34 0.01 0.65-0.03 0.95-0.09z"/>
  ...
  const ThreeFanGpuComponent = useMemo(() => {
    return <BaseGpuIcon gpuVariant={variant} className={cn(className, outline && `[&>*]:stroke-black [&>*]:[stroke-alignment:outside] [&>*]:[stroke-width:0.5]`)} />;
