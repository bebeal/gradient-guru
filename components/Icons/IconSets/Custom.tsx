...
export const MissingNoSprite = forwardRef((props?: any, ref?: any) => {
  return (
    <svg ref={ref} viewBox="0 -0.5 24 56" shapeRendering="crispEdges" {...props}>
...
export const WildMissingNoAppeaered = forwardRef((props?: any, ref?: any) => {
  return (
    
    <svg ref={ref} viewBox="0 0 400 117" {...props} width={'100%'}>
    <g fillRule="evenodd">
