...
export const Spinner = ({ active=true, r=40, strokeWidth=10, color="accent", backgroundColor="muted", percentage=33, strokeLinecap='round', className, id=`spinner-${color}`, ...props }: SpinnerProps) => {
  ...
  return (
    <svg
      ...
      fill="transparent"
      stroke="transparent"
      className={cn('transition-all text-transparent', className)}
      {...props}
    >
      <defs>
      ...
      </defs>
      {
        ...
        <path
          ...
          stroke={`url(#backgroundStroke-${id})`}
...
export const Loader = forwardRef((props?: any, ref?: any) => {
  ...
  return (
    <Spinner ref={ref} className={cn("animate-spin", className)} {...rest} />
  )
});

export const DotDotDot = forwardRef((props: any, ref: any) => {
  const { className='', vertical=false, bounce=false, ...rest } = props;
  return (
    <div ref={ref} className={cn("flex gap-[0.5px] w-auto h-auto justify-center items-center", vertical ? "flex-col" : "flex-row", className)}>
      <DotMark width={'1em'} fill={'currentColor'} stroke={'currentColor'} strokeWidth={'1'} viewBox="0 0 32 32" className={cn("currentColor rounded-full flex w-auto h-auto", bounce && "animate-bigger-bounce duration-1000 delay-300")} />
      <DotMark width={'1em'} fill={'currentColor'} stroke={'currentColor'} strokeWidth={'1'} viewBox="0 0 32 32" className={cn("currentColor rounded-full flex w-auto h-auto", bounce && "animate-bigger-bounce duration-1000 delay-500")} />
      <DotMark width={'1em'} fill={'currentColor'} stroke={'currentColor'} strokeWidth={'1'} viewBox="0 0 32 32" className={cn("currentColor rounded-full flex w-auto h-auto", bounce && "animate-bigger-bounce duration-1000 delay-700")} />
    </div>
  );
});
...
export const HorizontalDots = forwardRef((props?: any, ref?: any) => {
  const { className='', ...rest } = props;
  return (
    <DotDotDot ref={ref} vertical={false} className={cn(className)} {...rest} />
  )
});
...
export const VerticalDots = forwardRef((props?: any, ref?: any) => {
  const { className='', ...rest } = props;
  return (
    <DotDotDot ref={ref} vertical={true} className={cn(className)} {...rest} />
  )
});
...
export const DotsLoader = forwardRef((props?: any, ref?: any) => {
  const { className='', ...rest } = props;
  return (
    <DotDotDot ref={ref} bounce={true} className={className} {...rest} />
  )
});
...
export const LoadingChat = forwardRef((props?: any, ref?: any) => {
  const { className='', ...rest } = props;
  return (
    <div ref={ref} className={cn('relative flex h-auto w-auto items-center justify-center overflow-hidden', className)} {...rest}>
      <EmptyChat className={"w-full h-full"} />
      <div className={cn('absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[65%] h-full')}>
        <DotsLoader className={"w-full h-full"} />
      </div>
    </div>
  ...
  return (
    <div ref={ref} className={cn('relative flex h-auto w-auto items-center justify-center overflow-hidden', className)} {...rest}>
      ...
      <div className={cn('absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2')}>
        <StatusPartialFail strokeWidth={"1"} stroke={"currentColor"} fill={"currentColor"} height={'0.8em'} viewBox="0 0 32 32" className={"w-full h-full translate-y-[-0.1em] animate-pulse"} />
      </div>
    </div>
  );
});
  ...
  return (
    <div ref={ref} className={cn('relative flex h-auto w-auto items-center justify-center overflow-hidden', className)} {...rest}>
      ...
      <div className={cn('absolute top-1/2 left-1/2 transform -translate-x-1/2 translate-y-[-75%]')}>
        <CenterCircle strokeWidth={"1"} stroke={"currentColor"} fill={"currentColor"} height={'0.7em'} viewBox="0 0 32 32" className={"w-full h-full animate-focus-chat p-[0.1em]"} />
      </div>
    </div>
  );
});
...
export const CopySuccess = forwardRef((props?: any, ref?: any) => {
  return (
    <svg ref={ref} fill={"currentColor"} viewBox="0 0 32 32" {...props}>
      <path stroke="none" fill="currentColor" d="M28,10V28H10V10H28m0-2H10a2,2,0,0,0-2,2V28a2,2,0,0,0,2,2H28a2,2,0,0,0,2-2V10a2,2,0,0,0-2-2Z"/> <path stroke="none" fill="currentColor" d="M4,18H2V4A2,2,0,0,1,4,2H18V4H4Z"/> <path stroke="none" fill="currentColor" d="m14.73 21.134-2.2194-2.1771 1.3125-1.3325 1.2242 1.1919c0.6733 0.65553 1.3893 1.3354 1.5911 1.5108l0.36688 0.31894 6.8473-6.689 1.3359 1.3359-4.0317 3.9806c-2.2174 2.1893-4.0712 3.9934-4.1195 4.0091-0.04831 0.01567-1.0866-0.95119-2.3072-2.1486z" fillRule="evenodd" strokeOpacity="0"/>
    </svg>
  )
});
...
const Check = forwardRef((props?: any, ref?: any) => {
    return (
      <svg ref={ref} height={'1em'} viewBox="0 0 8 8" {...props}>
        <path
          fillRule="evenodd"
          clipRule="evenodd"
