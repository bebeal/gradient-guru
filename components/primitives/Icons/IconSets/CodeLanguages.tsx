...
export const CodeLanguagesIconSet: IconSetMap = Object.entries(CodeLanguages).reduce<Record<CodeLanguage, CodeLanguageProperties>>((acc, [codeLanguage, codeLanguageProperties]) => {
