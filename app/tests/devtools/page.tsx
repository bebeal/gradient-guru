...
const ReactGeigerTool = () => {
  ...
  return (
    <IconButton className="p-2 hover:cursor-pointer pointer-events-auto" color="jade" radius="large" variant="surface" onMouseMove={handleMouseMove}>
...
const DevToolsPage: FC = () => {
  return (
    <ComponentMapper title="Dev Tools" components={DevToolExamples} />
  );
};
