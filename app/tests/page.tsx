...
const TestsPage = () => {
  ...
  const title = 'Tests';
  const pages: string[] = ['assets', 'auth', 'buttons', 'data-grid', 'directory-tree', 'fun', 'google-drive', 'icon-sets', 'key-logger', 'mdx', 'plotly', 'primitives', 'radix-themed-components', 'styled-components', 'syntax-highlighter', 'tailwindcss', 'terminal', 'tiptap', 'tldraw', 'tweet'];
