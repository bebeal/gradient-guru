...
const schema = yup.object({
    ...
    experimental2: yup.boolean().default(true).label('Experimental2').meta({ type: 'switch', disabled: false }),
    conditional2: yup.boolean().label('Conditional2').meta({ type: 'switch', disabled: (form: any) => !form?.watch('experimental')}),
    ...
    default: yup.boolean().label('default').default(false).meta({ type: 'checkbox', disabled: false }),
    default2: yup.boolean().label('default2').default(false).meta({ type: 'switch', disabled: false }),
