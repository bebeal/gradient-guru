...
const strikethroughTextExample = `
...
const taskListExample = `<ul data-type="taskList">
...
const codeExample = `<code>const gaussFormula = (n)  => {
  return n * (n + 1) / 2;
}
</code>
`;
...
const superscriptExample = `
<p>
  The area of a circle is πr<sup>2</sup>.
</p>
`;

const subscriptExample = `
<p>
...
const invisibleCharacterExample = `
<h1>
This is a heading.
</h1>
<p>
...
const TipTapPage = () => {
  ...
  return (
    <div className={cn(`w-full h-[100vh] flex flex-col overflow-hidden`)}>
