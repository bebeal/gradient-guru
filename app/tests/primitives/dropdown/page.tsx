...
import { DropdownMenu, PreviewNodeDropdown } from '@/components';
...
const DropdownMenuPage = () => {
  const DropdownItems: any[] = [
    ...
    { type: 'sub', children: 'Open File', shortcut: '⌘O', items: [{ children: 'File', type: 'item' }, { children: 'Folder', type: 'item' }] },
    { type: 'checkbox', children: 'Checkbox' },
    { type: 'checkbox', children: 'Checked', checked: true },
    { type: 'radio', children: 'Radio', items: [
        { children: 'Radio 1', },
        { children: 'Radio 2', },
        { children: 'Radio 3', },
      ]
