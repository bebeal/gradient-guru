...
const GridDemo = () => {
  const gridCode = `<div class="bg-grid-white/[0.2]">grid</div>`;
  return (
...
const GridSmallDemo = () => {
  const smallGridCode = `<div class="bg-grid-sm-white/[0.2]">small grid</div>`;
  return (
...
const DotDemo = () => {
  const dotCode = `<div class="bg-dot-white/[0.2]">dot</div>`;
  return (
...
const GlassDemo = () => {
  const glassCode = `<div class="glass">glass</div>`;
  return (
