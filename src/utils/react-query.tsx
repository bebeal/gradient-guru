...
export const ReactQueryDevToolPanel: React.FC<any> = ({ visible }: { visible: boolean; setVisible: (value: boolean) => void; toggle: () => void }) => {
  return (
...
const ReactQueryDevToolToggle: React.FC<any> = ({ toggle }: { visible: boolean; setVisible: (value: boolean) => void; toggle: () => void }) => {
  return (
