...
const PinDemo = () => {
  return (
    <PinContainer title={'3D Pin Title'} href={'/'}>
  ...
  return (
    <div className="h-[400px] w-full bg-neutral-950 relative flex flex-col items-center justify-center antialiased">
      <div className="max-w-2xl mx-auto p-4">
        <h1 className="relative z-10 text-sm  bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-600  text-center font-sans font-bold">Background Beams</h1>
        <p></p>
      </div>
      <BackgroundBeams />
    </div>
...
const EvervaultCardDemo = () => {
  return (
    <div className="border border-black/[0.2] dark:border-white/[0.2] flex flex-col items-start max-w-sm mx-auto p-4 relative h-auto overflow-hidden">
      ...
      <h2 className="dark:text-white text-black mt-4 text-sm font-light">Hover over this card to reveal an awesome effect. Running out of copy here.</h2>
      <p className="text-sm border font-light dark:border-white/[0.2] border-black/[0.2] rounded-full mt-4 text-black dark:text-white px-2 py-0.5">Watch me hover</p>
    </div>
  );
};
...
const GoogleGeminiEffectDemo = () => {
  ...
  return (
    <div className="relative bg-black w-full dark:border dark:border-white/[0.1] rounded-md text-xs overflow-y-auto" ref={ref}>
    ...
    <div className="flex py-20 items-center justify-center antialiased">
      <GlowingStarsBackgroundCard>
        ...
        <div className="flex justify-between items-end">
          <GlowingStarsDescription>The power of full-stack to the frontend. Read the release notes.</GlowingStarsDescription>
...
const GlowingStarIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="h-4 w-4 text-white stroke-2">
...
const SparklesDemo = () => {
  return (
    <div className="h-auto w-full bg-black flex flex-col items-center justify-center overflow-hidden rounded-md">
      <h1 className="font-bold text-center text-white relative z-20">Aceternity</h1>
        ...
        <div className="w-full h-auto mx-auto antialiased pt-4 relative">
          {mockData.map((item, index) => (
            <div key={`content-${index}`} className="mb-10">
              ...
              <p className={cn('text-xl mb-4')}>{item.title}</p>
...
const DemoCardDemo = () => {
  return <Demo title="Demo Title" description="Demo Description" pinTitle="Demo Pin Title" href="/" />;
};
...
const FunPage: FC = () => {
  return <ComponentMapper title="Fun Components" components={FunComponents} />;
};
