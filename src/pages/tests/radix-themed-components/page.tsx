            ...
            <Dialog.Content size="1" style={{ maxWidth: 300 }}>
              ...
              <Flex direction="column" gap="3">
                <label>
                  ...
                  <TextField.Root size="1" defaultValue="Freja Johnsen" placeholder="Enter your full name" />
                </label>
                <label>
                  <Text as="div" size="1" mb="1" weight="bold">
                    Email
                  </Text>
                  <TextField.Root size="1" defaultValue="freja@example.com" placeholder="Enter your email" />
                </label>
              </Flex>
            ...
            <Dialog.Content size="4">
              ...
              <Flex direction="column" gap="5">
                <label>
                  ...
                  <TextField.Root size="3" defaultValue="Freja Johnsen" placeholder="Enter your full name" />
                </label>
                <label>
                  <Text as="div" size="3" mb="1" weight="bold">
                    Email
                  </Text>
                  <TextField.Root size="3" defaultValue="freja@example.com" placeholder="Enter your email" />
                </label>
              </Flex>
                        ...
                        <td key={variant}>
                          <Flex align="center" justify="center" gap="4">
                            ...
                            <DropdownMenu.Root>
                              ...
                              <DropdownMenu.Content variant={variant} color={color} highContrast>
                                <ExampleDropdownMenuContent />
                              </DropdownMenu.Content>
                            </DropdownMenu.Root>
                          </Flex>
                    ...
                    <tr key={variant}>
                      ...
                      <td>
                        <Select.Root defaultValue="apple">
                          ...
                          <Select.Content variant={selectTriggerVariantToSelectContentVariant(variant)} color="gray" highContrast>
                            <ExampleSelectContent />
                          </Select.Content>
                        </Select.Root>
                      </td>
                      ...
                      {selectTriggerPropDefs.variant.values.map((variant) => (
                        <td key={variant}>
                          <Select.Root defaultValue="apple">
                            ...
                            <Select.Content variant={selectTriggerVariantToSelectContentVariant(variant)} color={color}>
                              <ExampleSelectContent />
                            </Select.Content>
                          </Select.Root>
                        </td>
          ...
          <Tabs.Content value="all-colors">
            <Box my="6">
              <table className={styles.table}>
                ...
                <tbody>
                  {themePropDefs.accentColor.values.map((color, index) => (
                    <tr key={color}>
                      <td>{upperFirst(color)}</td>
                      {sliderPropDefs.variant.values.map((variant) => (
                        <React.Fragment key={variant}>
                    ...
                    <tr key={variant}>
                      ...
                      <td>
                        <TextField.Root variant={variant}>
                          ...
                          <TextField.Root placeholder="Search" defaultValue="Quick brown fox" disabled />
                          <TextField.Slot>
                      ...
                      <td>
                        <TextField.Root variant={variant}>
                          ...
                          <TextField.Root placeholder="Search" defaultValue="Quick brown fox" readOnly />
                          <TextField.Slot>
                            <IconButton variant="ghost" color="gray" size="1">
                              <InfoCircledIcon />
                            </IconButton>
                  ...
                  {textFieldRootPropDefs.variant.values.map((variant, index) => (
                    <React.Fragment key={variant}>
                      ...
                      <tr>
                        ...
                        {textFieldRootPropDefs.radius.values.map((radius) => (
                          <td key={radius}>
                            <TextField.Root size="1" variant={variant} radius={radius} style={{ width: 140 }}>
                              <TextField.Slot>
                      ...
                      <tr>
                        ...
                        {textFieldRootPropDefs.radius.values.map((radius) => (
                          <td key={radius}>
                            <TextField.Root size="2" variant={variant} radius={radius} style={{ width: 160 }}>
                              <TextField.Slot>
                                <MagnifyingGlassIcon width="16" height="16" />
                              </TextField.Slot>
                              <TextField.Root placeholder="Search" />
                      ...
                      <tr>
                        ...
                        {textFieldRootPropDefs.radius.values.map((radius) => (
                          <td key={radius}>
                            <TextField.Root size="3" variant={variant} radius={radius}>
                              <TextField.Slot>
...
const InsetImage = (props: React.ComponentPropsWithoutRef<'img'> & { style?: any }) => (
  <img
...
const PanelBackgroundImage = ({ id, style, ...props }: React.ComponentPropsWithoutRef<'svg'> & { id: string; style?: any }) => (
