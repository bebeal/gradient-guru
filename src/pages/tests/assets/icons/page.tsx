...
import { AnimatedDashedPath, AnimatedLineSVG, MissingNoSprite, WildMissingNoAppeaered } from '@/components/Primitives/Icons/CustomIcons';
  ...
  return (
    <div className="w-full h-full p-10">
      <MachineLeaerningIcon
        ...
        height="200"
        viewBox="0 0 32 32"
        className="rounded-lg animate-spin [animation-duration:5s] duration-1000 fill-current stroke-current hover:animate-spin hover:[animation-duration:1s] transition-transform ease-in-out bg-gradient-to-r from-sky-400 to-violet-400 text-black"
      />
    </div>
  );
};
