...
const ToolbarActions = (editor: any): ToolbarAction[] => [
  {
    ...
    onClick: (_event: any) => editor.chain().focus().toggleBold().run(),
  ...
  },
  {
    ...
    onClick: (_event: any) => editor.chain().focus().toggleItalic().run(),
  ...
  },
  {
    ...
    onClick: (_event: any) => editor.chain().focus().toggleUnderline().run(),
    disable: false,
  ...
  },
  {
    ...
    onClick: (_event: any) => editor.chain().focus().toggleStrike().run(),
  ...
  },
  {
    ...
    onClick: (_event: any) => editor.chain().focus().toggleCode().run(),
  ...
  },
  {
    ...
    onClick: (_event: any) => editor.chain().focus().toggleHeading({ level: 1 }).run(),
    disable: false,
  ...
  },
  {
    ...
    onClick: (_event: any) => editor.chain().focus().toggleHeading({ level: 2 }).run(),
    disable: false,
  ...
  },
  {
    ...
    onClick: (_event: any) => editor.chain().focus().toggleHeading({ level: 3 }).run(),
    disable: false,
  ...
  },
  {
    ...
    onClick: (_event: any) => editor.chain().focus().toggleHeading({ level: 4 }).run(),
    disable: false,
  ...
  },
  {
    ...
    onClick: (_event: any) => editor.chain().focus().toggleHeading({ level: 5 }).run(),
    disable: false,
  ...
  },
  {
    ...
    onClick: (_event: any) => editor.chain().focus().setParagraph().run(),
    disable: false,
  ...
  },
  {
    ...
    onClick: (_event: any) => editor.chain().focus().toggleBulletList().run(),
    disable: false,
  ...
  },
  {
    ...
    onClick: (_event: any) => editor.chain().focus().toggleOrderedList().run(),
    disable: false,
  ...
  },
  {
    ...
    onClick: (_event: any) => editor.chain().focus().toggleHighlight().run(),
    disable: false,
  ...
  },
  {
    ...
    onClick: (_event: any) => editor.chain().focus().setTextAlign('left').run(),
    disable: false,
  ...
  },
  {
    ...
    onClick: (_event: any) => editor.chain().focus().setTextAlign('center').run(),
    disable: false,
  ...
  },
  {
    ...
    onClick: (_event: any) => editor.chain().focus().setTextAlign('right').run(),
    disable: false,
  ...
  },
  {
    ...
    onClick: (_event: any) => editor.chain().focus().setTextAlign('justify').run(),
    disable: false,
  ...
  },
  {
    ...
    onClick: (_event: any) => editor.chain().focus().toggleCodeBlock().run(),
    disable: false,
  ...
  },
  {
    ...
    onClick: (_event: any) => editor.chain().focus().toggleBlockquote().run(),
    disable: false,
  ...
  },
  {
    ...
    onClick: (_event: any) => editor.chain().focus().insertTable({ rows: 3, cols: 3, withHeaderRow: true }).run(),
    disable: false,
