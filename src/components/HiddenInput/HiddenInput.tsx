...
export const HiddenInput = (props: HiddenInputProps) => {
  const { localStorageKey = 'gg_api_key', onChange, value } = props;
  ...
  return (
    <div className={cn(`w-full flex flex-col items-center justify-center pointer-events-none text-secondary z-[var(--layer-overlays)]`)}>
