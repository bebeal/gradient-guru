    ...
    >
      ...
      >
        {showValue && showValue !== 'none' && (
          <span className={cn(`absolute text-primary/50 text-xs top-[-.75em] -translate-x-1/2 -translate-y-1/2 pointer-events-none text-center leading-none`)} style={{ left: calcStepMarkOffset(internalValue, min, max, thumbSize) }}>
