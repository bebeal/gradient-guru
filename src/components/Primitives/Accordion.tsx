...
import { ConvertRadiusClass, Radius, RadiusClasses } from '@/utils/styles';
...
export const Accordion = (props: AccordionProps) => {
  ...
  const getValues: any = useCallback((values: any) => values?.filter((item: any) => item.open).map((_item: any, index: number) => `accordion-item-${index}`), []);
