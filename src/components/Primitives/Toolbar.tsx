...
export const ToolbarButton = (props: ToolbarButtonProps) => {
  return (
    <ToolbarPrimitive.Button asChild className={cn('relative flex w-auto h-auto px-2.5 py-2')}>
      <Button {...props} />
...
export const ToolbarSeparator = (props: ToolbarSeparatorProps) => {
  return <ToolbarPrimitive.Separator className={cn('w-[1px] text-[rgb(var(--text-primary))] bg-[rgb(var(--text-primary))] py-2.5 ')} {...props} />;
};
...
export const ToolbarLink = (props: ToolbarLinkProps) => {
  return (
    <ToolbarPrimitive.Link
      target="_blank"
      className={cn('text-sm text-secondary relative flex justify-center items-center w-auto h-auto', 'hover:text-primary', 'focus:outline-none focus-visible:z-20 focus-visible:ring focus-visible:ring-accent focus-visible:ring-opacity-75')}
      {...props}
    />
  );
};
...
export const ToolbarGroup = (props: ToolbarGroupProps) => {
  ...
  return (
    <ToolbarPrimitive.ToggleGroup className={cn('relative flex justify-stretch items-stretch w-auto h-auto', className)} type="multiple">
...
export const Toolbar = forwardRef<ElementRef<typeof ToolbarPrimitive.Root>, ToolbarProps>((props, ref) => {
  ...
  return (
    mounted && (
      <ToolbarPrimitive.Root ref={ref} className={cn('flex w-auto h-auto items-center justify-center bg-primary text-primary', 'flex-col md:flex-row md:flex-wrap', className)} {...rest}>
        {items.map((toolbarItem, idx) => {
