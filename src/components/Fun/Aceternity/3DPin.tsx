...
export const PinContainer = ({ children, title, href, className, containerClassName }: { children: React.ReactNode; title?: string; href?: string; className?: string; containerClassName?: string }) => {
  ...
  return (
    <a
      ...
      className={cn('relative group/pin z-[var(--layer-toasts)] cursor-pointer flex overflow-hidden h-auto w-auto min-w-[400px] min-h-[460px]', containerClassName)}
    ...
    >
      <div
        ...
        className="absolute left-1/2 top-1/2 ml-[0.09375rem] mt-4 -translate-x-1/2 -translate-y-1/2 w-auto h-auto flex"
      >
        <div
          style={{
            transform: transform,
